...
DEFAULT_VERSION = "MooTools Development"
...
PROJECTS = {
  "MooTools Development": {
    "Core": {
      ...
      "docs": "lib/core/Docs",
      "specs": ["lib/core-specs/1.3base/package.yml", "lib/core-specs/1.3client/package.yml", "lib/core-specs/1.4client/package.yml"],
      "build": True
    },
    "More": {
      "package": "lib/more/package.yml",
      "docs": "lib/more/Docs",
      "specs": ["lib/more/Tests/Specs/package.yml"],
      "demos": {
        "path": "lib/more/Tests/Interactive"
      },
      "build": True
    }
  }
